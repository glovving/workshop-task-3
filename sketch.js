...
function preload(){
  ...
  bg1 = loadImage('imagesref/flowers.jpg');
  bg2 = loadImage('imagesref/cigaretteteeth.jpg');
  bg3 = loadImage('imagesref/eyes.jpg');

  bgarray = [bg1, bg2, bg3];

  st1 = loadImage('imagesref/bear_sticker.png');
  st2 = loadImage('imagesref/elephant_sticker.png');
  st3 = loadImage('imagesref/fish_sticker.png');
  st4 = loadImage('imagesref/gorillaface_sticker.png');
  st5 = loadImage('imagesref/scaryface_sticker.png');
...
function unique_bg(){
    let rand_effect = floor(random(1, 7));
